...
{
//   printk(KERN_INFO "da vao ham batadv_send_skb_packet: %pM  **** %pM\n",dst_addr,hard_iface->net_dev->dev_addr);
...
{
//   printk(KERN_INFO "da vao ham batadv_send_skb_to_orig\n");
...
{
//     printk(KERN_ALERT "*******************************\n");
//     printk(KERN_ALERT "Go to: batadv_schedule_bat_ogm\n");
// //   printk(KERN_ALERT "Send OGMs packet: 5\n");
	struct batadv_priv *bat_priv = netdev_priv(hard_iface->soft_iface);
...
{
//   printk(KERN_ALERT "*******************************\n");
//   printk(KERN_ALERT "Go to: batadv_send_outstanding_bat_ogm_packet\n");
//   printk(KERN_ALERT "Send OGMs packet: 1\n");
	struct delayed_work *delayed_work;
	struct batadv_forw_packet *forw_packet;
	struct batadv_priv *bat_priv;
	 ...
	 */
// 	printk(KERN_ALERT "Send OGMs packet: 1-0\n");
	if (forw_packet->own &&
	    forw_packet->if_incoming == forw_packet->if_outgoing)
		batadv_schedule_bat_ogm(forw_packet->if_incoming);
// 	    printk(KERN_ALERT "Send OGMs packet: 1-1\n");
...
out:
	...
	batadv_forw_packet_free(forw_packet);
	//printk(KERN_ALERT "Send OGMs packet: 11\n");
}
